...
#version 1 (matches GWs better)
xl[plotr][Hz],yl[plotr][Hz]=[9.4,16.5,39.7,64.,67.],[452.3,428.,449.2,507.,577.]
xh[plotr][Hz],yh[plotr][Hz]=[9.4,13.,20.5,36.,62.,67.],[452.3,525.3,540.5,571.,586.,577.]

#version 2 (doesn't match GWs as well)
...
################################
### rot='2.0', normal resolution
################################

plotr='2.0' #rotation case
...
xl[plotr][Hz],yl[plotr][Hz]=[17.,21.3,35.,78.,80.4],[1476.,1400.,1446.7,1586.4,1668.]
xh[plotr][Hz],yh[plotr][Hz]=[17.,26.,42.1,63.4,78.,80.4],[1476.,1540.,1621.3,1714.4,1731.9,1668.]

# 1270-1500 Hz mode

Hz='1400'

xl[plotr][Hz],yl[plotr][Hz]=[5.7,6.915,12.1897,20.55,26.3117,42.8685,66.2427,78.,80.0],[1220.,1170.,1175.73,1200.5,1235.64,1325.3,1415.97,1446.01,1499.]
xh[plotr][Hz],yh[plotr][Hz]=[5.7,9.0,15.111,34.103,62.834,77.5,80.0],[1220.,1295.0,1340.38,1415.97,1510.5,1540.46,1499.]

# 1020-1060 Hz mode

Hz='1100'

xl[plotr][Hz],yl[plotr][Hz]=[13.1,18.4,25.,50.6,77.6,80.],[972.,949.5,960.,989.,1022.7,1067.7]
xh[plotr][Hz],yh[plotr][Hz]=[13.1,13.3,24.1,40.2,77.,80.],[972.,1062.,1102.,1130.,1129.7,1067.7]

# 900-915 Hz mode

Hz='900'

xl[plotr][Hz],yl[plotr][Hz]=[16.6,25.5,50.6,76.6,80.],[887.5,848.,853.7,865.,910.]
xh[plotr][Hz],yh[plotr][Hz]=[16.6,24.6,51.,75.,80.],[887.5,955.,972.,989.,910.]

# 770 Hz mode

Hz='750'

xl[plotr][Hz],yl[plotr][Hz]=[17.,20.4,71.,79.],[752.4,707.3,712.9,752.4]
xh[plotr][Hz],yh[plotr][Hz]=[17.,23.7,50.6,77.5,79.],[752.4,814.3,848.,836.8,752.4]

# 650 Hz mode

Hz='650'

xl[plotr][Hz],yl[plotr][Hz]=[12.8,17.5,22.8,35.6,59.3,69.3,73.],[646.6,699.5,705.4,705.4,705.4,693.7,634.8]
xh[plotr][Hz],yh[plotr][Hz]=[12.8,18.5,68.4,73.],[646.6,587.7,593.6,634.8]

# 520 Hz mode

Hz='500'

xl[plotr][Hz],yl[plotr][Hz]=[6.63,9.9,18.5,46.8,76.,79.4],[538.4,488.,476.4,476.4,504.6,549.6]
xh[plotr][Hz],yh[plotr][Hz]=[6.63,10.9,20.3,66.2,77.,79.4],[538.4,589.,594.7,600.,577.8,549.6]

# 400 Hz mode

Hz='350'

xl[plotr][Hz],yl[plotr][Hz]=[9.7,12.5,19.,79.3,80.2],[386.,341.5,325.,347.,419.4]
xh[plotr][Hz],yh[plotr][Hz]=[9.7,13.9,22.,44.,77.4,80.2],[386.,436.,469.5,475.,497.4,419.4]
...
################################
### rot='2.5', normal resolution
################################

plotr='2.5' #rotation case
...
xl[plotr][Hz],yl[plotr][Hz]=[14.7,27.2,35.7,63.2,95.6,105.4,108.2],[1177.5,1143.3,1157.9,1280.,1387.9,1437.,1466.]
xh[plotr][Hz],yh[plotr][Hz]=[14.7,19.8,46.7,85.,104.,108.2],[1177.5,1290.,1388.,1496.,1520.,1466.]

# 1000-1040 Hz mode

Hz='1100'

xl[plotr][Hz],yl[plotr][Hz]=[15.5,19.7,45.4,64.3,70.4],[1021.,967.,972.,1001.4,1040.5]
xh[plotr][Hz],yh[plotr][Hz]=[15.5,20.3,28.3,64.7,70.4],[1021.,1050.3,1080.,1089.4,1040.5]

# 880 Hz mode

Hz='900'

xl[plotr][Hz],yl[plotr][Hz]=[15.5,17.3,30.,68.,78.4,80.8],[888.9,850.7,825.,820.4,854.6,874.]
xh[plotr][Hz],yh[plotr][Hz]=[15.5,21.,50.9,75.3,80.8],[888.9,942.6,952.5,923.,874.]

# 730 Hz mode

Hz='750'

xl[plotr][Hz],yl[plotr][Hz]=[20.7,23.8,29.3,68.4,72.6],[707.8,683.4,673.5,688.3,722.5]
xh[plotr][Hz],yh[plotr][Hz]=[20.7,23.1,38.4,65.9,72.6],[707.8,766.5,781.2,781.2,722.5]

# 620-640 Hz mode

Hz='650'

xl[plotr][Hz],yl[plotr][Hz]=[18.3,22.5,33.5,42.,79.4,83.],[614.9,573.8,568.,568.,614.9,649.1]
xh[plotr][Hz],yh[plotr][Hz]=[18.3,21.9,29.9,52.9,77.5,83.],[614.9,673.6,683.4,688.5,688.3,649.1]

# 440-480 Hz mode

Hz='500'

xl[plotr][Hz],yl[plotr][Hz]=[20.7,23.2,32.,49.5,103.8,108.],[448.5,404.5,384.9,394.7,419.2,473.]
xh[plotr][Hz],yh[plotr][Hz]=[20.7,26.3,36.,52.5,103.2,108.],[448.5,492.6,512.1,517.,521.9,473.]

# 280 Hz mode

Hz='350'

xl[plotr][Hz],yl[plotr][Hz]=[9.8,14.6,32.4,79.4,96.7,104.],[282.2,228.4,228.5,238.2,247.5,297.]
xh[plotr][Hz],yh[plotr][Hz]=[9.8,15.8,39.7,84.4,100.,104.],[282.2,360.7,360.9,355.,341.,297.]

# 180 Hz mode

Hz='200'

xl[plotr][Hz],yl[plotr][Hz]=[15.8,18.9,31.7,74.,80.],[189.2,140.3,115.9,115.8,179.5]
xh[plotr][Hz],yh[plotr][Hz]=[15.8,22.,28.7,43.4,75.8,80.],[189.2,214.,233.3,238.2,218.6,179.5]
